                  ...
                  <h4 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
                    ...
                    <button
                      onClick={() => {
                        ...
                        if (userScreenshot) downloadScreenshot(`{import.meta.env.VITE_API_URL}${userScreenshot}`, `${submission.candidateName}-output.png`);
                        if (expectedScreenshot) downloadScreenshot(`{import.meta.env.VITE_API_URL}${expectedScreenshot}`, `expected-output.png`);
                        if (diffScreenshot) downloadScreenshot(`{import.meta.env.VITE_API_URL}${diffScreenshot}`, `diff-output.png`);
                      }}
                      ...
                      <div className="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div 
                          ...
                          onClick={() => setScreenshotModal({
                            src: `{import.meta.env.VITE_API_URL}${submission.user_screenshot || submission.result.visual.screenshots.candidate}`,
                    ...
                    {(submission.expected_screenshot || submission.result?.visual?.screenshots?.expected) && (
                      <div className="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div 
                          className="p-2 cursor-pointer hover:opacity-80 transition-opacity"
                          onClick={() => setScreenshotModal({
                            src: `{import.meta.env.VITE_API_URL}${submission.expected_screenshot || submission.result.visual.screenshots.expected}`,
                    ...
                    {submission.result?.visual?.screenshots?.diff && (
                      <div className="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div 
                          className="p-2 cursor-pointer hover:opacity-80 transition-opacity"
                          onClick={() => setScreenshotModal({
                            src: `{import.meta.env.VITE_API_URL}${submission.result.visual.screenshots.diff}`,
