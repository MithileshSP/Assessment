...
export default function LevelChallenge() {
  ...
  const loadLevelQuestions = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_API_URL}/challenges/level-questions`, {
        params: { 
          userId, 
          courseId, 
  ...
  const loadCurrentQuestion = async () => {
    ...
    try {
      const response = await axios.get(`${import.meta.env.VITE_API_URL}/challenges/${questionId}`);
  ...
  const loadRestrictions = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_API_URL}/courses/${courseId}/restrictions`);
      if (response.data) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const submitResponse = await axios.post(`${import.meta.env.VITE_API_URL}/submissions`, {
      ...
      const evalResponse = await axios.post(`${import.meta.env.VITE_API_URL}/evaluate`, {
  ...
  const handleSubmitFeedback = async () => {
    try {
      ...
      // Save to backend
      await axios.post(`${import.meta.env.VITE_API_URL}/level-completion`, completionData);
