...
CREATE TABLE IF NOT EXISTS submission_assignments (
    ...
    status ENUM('pending', 'evaluated', 'unassigned', 'assigned', 'in_progress', 'reallocated', 'reopened', 'ai_error') DEFAULT 'pending',
    ai_processing_started_at TIMESTAMP NULL,
